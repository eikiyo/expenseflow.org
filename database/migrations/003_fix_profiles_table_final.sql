...
-- Drop existing trigger if it exists (but keep the function since expenses table uses it)
DROP TRIGGER IF EXISTS update_profiles_updated_at ON public.profiles;

-- Create or replace the function (this will work since it's the same function)
